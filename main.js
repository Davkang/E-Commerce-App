...
class Product {
  ...
  // instance method that decrease the quantity of a product by one
  sell(){
    if (this.quantity > 0){
      this.quantity =- 1;
    }
  ...
  // instance method that generates the HTML representation of the object.
  toHTML(){
    let htmlString = "";
    ...
    // htmlString += `<img src="images/la-large-sticker.png" alt="Large Launch Academy Sticker" />`;
